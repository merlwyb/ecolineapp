package com.ecoline.application.views.masterdetail2;

import com.ecoline.application.data.entity.SampleBook;
import com.ecoline.application.data.service.SampleBookService;
...
@RolesAllowed("admin")
public class MasterDetail2View extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "master-detail2/%d/edit";
    ...
    public MasterDetail2View(@Autowired SampleBookService sampleBookService) {
        this.sampleBookService = sampleBookService;
        addClassNames("master-detail2-view", "flex", "flex-col", "h-full");
