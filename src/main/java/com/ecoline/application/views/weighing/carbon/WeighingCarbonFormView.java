...
@Route(value = "weighing-form-carbon", layout = MainLayout.class)
@RolesAllowed({"admin", "weigher_carbon"})
@Uses(Icon.class)
public class WeighingCarbonFormView extends Div {
    ...
    public WeighingCarbonFormView(@Autowired TechnologicalCardService technologicalCardService,
        ...
        grid.setItems(technologicalCardService.getAllWhereCarbon());
        ...
        try {
            ...
            binder.setBean(new ComponentPortion("Техуглерод"));
