...
@Route(value = "weighing-form-bulk", layout = MainLayout.class)
@RolesAllowed({"admin", "weigher_bulk"})
@Uses(Icon.class)
public class WeighingBulkFormView extends Div {
    ...
    public WeighingBulkFormView(@Autowired TechnologicalCardService technologicalCardService,
        ...
        grid.setItems(technologicalCardService.getAllWhereBulk());
        ...
        try {
            ...
            binder.setBean(new ComponentPortion("Сыпучая смесь"));
