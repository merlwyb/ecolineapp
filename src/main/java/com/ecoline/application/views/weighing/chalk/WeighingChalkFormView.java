...
@Route(value = "weighing-form-chalk", layout = MainLayout.class)
@RolesAllowed({"admin", "weigher_chalk"})
@Uses(Icon.class)
public class WeighingChalkFormView extends Div {
    ...
    public WeighingChalkFormView(@Autowired TechnologicalCardService technologicalCardService,
        ...
        grid.setItems(technologicalCardService.getAllWhereChalk());
        ...
        try {
            ...
            binder.setBean(new ComponentPortion("Мел"));
