package com.ecoline.application.views.masterdetail3;

import com.ecoline.application.data.entity.SampleFoodProduct;
import com.ecoline.application.data.service.SampleFoodProductService;
...
@Route(value = "master-detail3/:sampleFoodProductID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("admin")
public class MasterDetail3View extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEFOODPRODUCT_EDIT_ROUTE_TEMPLATE = "master-detail3/%d/edit";
    ...
    public MasterDetail3View(@Autowired SampleFoodProductService sampleFoodProductService) {
        this.sampleFoodProductService = sampleFoodProductService;
        addClassNames("master-detail3-view", "flex", "flex-col", "h-full");
