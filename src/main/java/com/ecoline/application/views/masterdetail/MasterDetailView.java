package com.ecoline.application.views.masterdetail;

import com.ecoline.application.data.entity.SampleAddress;
import com.ecoline.application.data.service.SampleAddressService;
...
public class MasterDetailView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEADDRESS_EDIT_ROUTE_TEMPLATE = "master-detail/%d/edit";
    ...
    public MasterDetailView(@Autowired SampleAddressService sampleAddressService) {
